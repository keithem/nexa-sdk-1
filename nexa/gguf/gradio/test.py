...
model_path = "/Users/chenzekai/.cache/nexa/hub/official/OmniAudio-2.6B/model-q4_K_M.gguf"
...
def load_model(model_path):
    # Since is_local_path = True, we directly initialize NexaAudioLMInference with local paths
...
try:
    nexa_model = load_model(model_path)
...
with gr.Blocks() as demo:
    ...
    gr.HTML(
        ...
        <div style="font-family: Arial, sans-serif; font-size: 1em; color: #444;">
            ...
            <b>Model path: {model_path}</b><br>
            <b>Projector path: {projector_local_path}</b>
        </div>
        """
    )
